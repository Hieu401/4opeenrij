...
#todo: wincondition, als de top vol is, als de input niet binnen de gegeven kolomen valt, undo, full board, minimum
# boardsize, als de gegeven kollom of rij kleiner is dan de win condition
